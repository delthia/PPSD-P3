...
%\begin{itemize}
%    \item \url{https://support.mozilla.org/es/kb/Gestionar-la-configuraci%C3%B3n-del-almacenamiento-local-del-sitio?as=u&utm_source=inproduct&redirectslug=permission-store-data&redirectlocale=en-US}
%    \item \url{https://librewolf.net/docs/faq/#how-do-i-stay-logged-into-specific-websites}
%    \item \url{https://addons.mozilla.org/en-US/firefox/addon/cookie-autodelete/}
%    \item \url{https://privacybadger.org/}
%\end{itemize}
...
En el cuadro \ref{tab:comparativa-cookies} podemos ver una comparación más visual de los 3 buscadores.
...
\hline
\multicolumn{1}{|c|}{\textbf{Características}} & \multicolumn{1}{c|}{\textbf{Firefox}} & \multicolumn{1}{c|}{\textbf{LibreWolf}} & \multicolumn{1}{c|}{\textbf{Chrome}} \\ \hline
...
\caption{Comparativa de las características de las cookies de cada buscador}
