...
\begin{figure}[H]   
    \includegraphics[width=15cm]{web_ej5a.png}
...
\begin{figure}[H]   
    \includegraphics[width=15cm]{paso1_ej5a.png}
    \caption{Paso 1}
    \label{fig:paso1}
\end{figure}

\begin{figure}[H]   
    \includegraphics[width=15cm]{instalacion_FNMT_ej5a.png}
...
\begin{figure}[H]   
    \includegraphics[width=15cm]{paso2_ej5a.png}
    \caption{Paso 2}
    \label{fig:paso2}
\end{figure}
...
\begin{figure}[H]   
    \includegraphics[width=15cm]{mapa_ej5a.png}
...
\begin{figure}[H]   
    \includegraphics[width=15cm]{paso4_ej5a.png}
    \caption{Paso 4}
    \label{fig:paso4}
\end{figure}

\begin{figure}[H]   
    \includegraphics[width=15cm]{fin_instalacion_ej5a.png}
